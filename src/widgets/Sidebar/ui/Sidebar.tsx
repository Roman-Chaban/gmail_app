...
export const Sidebar: FC = () => {
  return (
    <aside className='h-full w-full max-w-[15.5rem]'>
      <Container className='border-gray-shadow flex h-full w-full max-w-[15.5rem] flex-col justify-between gap-10 border-r-2 pt-4'>
